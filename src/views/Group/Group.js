...
import { Card, theme, p, Input } from "galio-framework";
...
class Group extends React.Component {
  ...
  renderGroupDiscussion = () => {
    ...
    return (
      <Card flex center style={styles.home}>
        <Card
          row
          style={{ marginTop: 10, zIndex: 2, alignSelf: "flex-start" }}
        >
          <p h3 color="grey" style={{ left: 20 }}>
            Discussion
          </p>
          {this.state.isMember ? this.renderAddPost() : this.renderJoinButton()}
          <Card right style={{ left: 20, top: 2 }}>
            <div onPressIn={this.chooseOptions}>
              <Icon
                family="Entypo"
                size={28}
        ...
        />
        <Card style={{ marginTop: 10, marginBottom: 120, zIndex: 1 }}>
          <FlatList
    ...
    return (
      <Card>
        ...
        >
          ...
          <Card flex left center style={{ marginTop: 80 }}>
            <Card row>
